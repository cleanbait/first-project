...
<form id="Product registration Form" action="love" method="post">
	<div class="fix">
		<div class="fix2">
			...
			<input type="submit" value="SUBMIT" style="width: 150px; font-size: 20px; background-color: #2C1B01; color: white; cursor: pointer; border: 0px; border-radius: 5px; padding: 10px;">
		</div>
	</div>
</form>
