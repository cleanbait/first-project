...
@font-face {
    src: url("${pageContext.request.contextPath}/resources/font/NanumPenScript-Regular.ttf");
    font-family: "Script";
}
...
<div class="fix">
	<div class="ff">
		<div class="fix2">
			<h1>OUR STORY</h1>
			<p>세상은 여우의 중심에서 환경을 외친다.</p>
		</div>
		<div class="fox">
			<img src="${pageContext.request.contextPath}/resources/img2/firefox.gif">
		</div>
		
    <a href="home"><button class="w-btn w-btn-gra3 w-btn-gra-anim" style="width: 250px; height: 30px; border: 0px;" type="button">FOX</button></a>
	</div>
</div>
